...
const IntroComponent = () => {
    ...
    return (
        <section className="flex items-center justify-center h-screen">
            ...
            <div>
                <h2 className="text-2xl font-semibold dark:text-gray-100">Hello!! My name is <span>Anirudh!</span></h2>
                <h3 className="dark:text-gray-200">I build web and mobile applications and sometimes try to design stuff.</h3>
                <h3 className="dark:text-gray-200">I also spend a lot of time breaking and fixing the stuff that I make.</h3>
                <div className="flex flex-row gap-5 mt-5 dark:text-gray-300">
